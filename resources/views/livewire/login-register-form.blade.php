<div class="z-3 position-absolute end-0 header-form-wrap">
    ...
    <form action="" class="p-4 login-form {{ $isShowLogin ? 'd-block' : 'd-none' }}" wire:submit="login">
    ...
    <form action="" class="p-4 register-form {{ $isShowRegister ? 'd-block' : 'd-none' }}" wire:submit="register">
